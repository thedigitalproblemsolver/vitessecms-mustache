...
class Engine extends Mustache_Engine
{
     ...
     *
     *         // Override core permissions for cache files. Defaults to using the system-defined umask. It is
     ...
     *         // This currently defaults to false, but will core to true in v3.0.
